...
def evaluation_10_fold(feature_path='/data2/saved_features/cur_epoch_result/mat'):
    ACCs = np.zeros(10)
...
def loadStateDict(resume):
    old_state_dict = torch.load(resume)
    new_state_dict = OrderedDict()
    for key in old_state_dict.keys():
        new_state_dict['.'.join(key.split('.')[1:])] = old_state_dict[key]
...
def evaluationAPI(epoch):
    print('Starting evaluation epoch %d ...'%epoch)
    resume = '/data2/snapshot/epoch_%d_iteration_800.pth'%epoch
    root = '/data2/datasets/lfw/lfw'
    file_list = '/data2/datasets/lfw/pairs.txt'
    backbone_net = 'Res50'
    gpus = '0,1,2,3'
    feature_save_path = '/data2/saved_features/cur_epoch_file.mat'
    net, device, lfw_dataset, lfw_loader = loadModel(root, file_list, backbone_net, gpus, resume)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='/data2/datasets/lfw/lfw', help='The path of lfw data')
    parser.add_argument('--file_list', type=str, default='/data2/datasets/lfw/pairs.txt', help='The path of lfw data')
    parser.add_argument('--backbone_net', type=str, default='Res50', help='MobileFace, Res50, Res101, Res50_IR, SERes50_IR')
    parser.add_argument('--feature_dim', type=int, default=512, help='feature dimension')
    parser.add_argument('--resume', type=str, default='/data2/snapshot/epoch_1_iteration_800.pth',
                        help='The path pf save model')
    parser.add_argument('--feature_save_path', type=str, default='/data2/saved_features/cur_epoch_file.mat',
